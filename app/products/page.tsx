  ...
  if (isShopifyConfigured()) {
    try {
      const data = await shopifyFetch<ProductsResponse>({
        ...
        variables: { first: 250 }, // fetch as many as possible
      });
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <section className="rounded-2xl border border-white/70 bg-white/75 p-6 shadow-[0_30px_100px_rgba(15,23,42,0.08)] backdrop-blur-xl sm:p-8 lg:p-10">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-2xl text-base leading-7 text-slate-600">
                Browse our complete collection – all products from your Shopify store.
              </p>
            </div>
        ...
        {loadError ? (
          <div className="mt-8 rounded-2xl border border-amber-200 bg-amber-50 p-5 text-sm font-medium text-amber-900 shadow-sm">
        ...
        <section className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          {products.map((product) => (
            <Link
              ...
              className="group flex h-full flex-col overflow-hidden rounded-2xl border border-white/70 bg-white/80 p-4 shadow-[0_20px_60px_rgba(15,23,42,0.06)] backdrop-blur-xl transition hover:-translate-y-1.5 hover:shadow-[0_28px_70px_rgba(15,23,42,0.12)]"
            >
              <div className="mb-4 overflow-hidden rounded-xl bg-gradient-to-b from-slate-50 to-indigo-50/50 p-4">
              ...
              <div className="flex flex-1 flex-col">
                ...
                <div className="mt-5 flex items-end justify-between gap-4 border-t border-slate-100 pt-4">
                  <div>
                    ...
                    <div className="mt-1 text-xs font-semibold text-amber-600">★ 4.8 rating</div>
                  </div>
