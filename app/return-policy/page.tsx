          ...
          <div className="mt-8 space-y-8 text-slate-700">
            <section>
              ...
              <p className="mt-2 text-sm leading-relaxed">
                duodrop operates this store and website, including all related information, content, features, tools,
                products and services, in order to provide you, the customer, with a curated shopping experience (the
                "Services"). duodrop is powered by Shopify, which enables us to provide the Services to you. This
                Privacy Policy describes how we collect, use, and disclose your personal information when you visit,
                use, or make a purchase or other transaction using the Services or otherwise communicate with us. If
                there is a conflict between our Terms of Service and this Privacy Policy, this Privacy Policy controls
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900">Personal Information We Collect or Process</h2>
              <p className="mt-2 text-sm leading-relaxed">
                When we use the term "personal information," we are referring to information that identifies or can
                reasonably be linked to you or another person. Personal information does not include information that
                ...
                inferences drawn from this personal information, depending on how you interact with the Services,
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900">Personal Information Sources</h2>
              <p className="mt-2 text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900">How We Use Your Personal Information</h2>
              <p className="mt-2 text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900">How We Disclose Personal Information</h2>
              <p className="mt-2 text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900">Relationship with Shopify</h2>
              <p className="mt-2 text-sm leading-relaxed">
                The Services are hosted by Shopify, which collects and processes personal information about your
                access to and use of the Services in order to provide and improve the Services for you. Information
                you submit to the Services will be transmitted to and shared with Shopify as well as third parties
                that may be located in countries other than where you reside, in order to provide and improve the
                Services for you. In addition, to help protect, grow, and improve our business, we use certain
                Shopify enhanced features that incorporate data and information obtained from your interactions
                with our Store, along with other merchants and with Shopify. To provide these enhanced features,
                Shopify may make use of personal information collected about your interactions with our store,
                along with other merchants, and with Shopify. In these circumstances, Shopify is responsible for
                the processing of your personal information, including for responding to your requests to exercise
                your rights over use of your personal information for these purposes. To learn more about how
                Shopify uses your personal information and any rights you may have, you can visit the
                <a
                ...
                Depending on where you live, you may exercise certain rights with respect to your personal
                information here
                <a
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900">Third Party Websites and Links</h2>
              <p className="mt-2 text-sm leading-relaxed">
                ...
                and security policies and other terms and conditions. We do not guarantee and are not responsible
                for the privacy or security of such sites, including the accuracy, completeness, or reliability
                of information found on these sites. Information you provide on public or semi-public venues,
                including information you share on third-party social networking platforms may also be viewable
                by other users of the Services and/or users of those third-party platforms without limitation as
                to its use by us or by a third party. Our inclusion of such links does not, by itself, imply any
                endorsement of the content on such platforms or of their owners or operators, except as disclosed
                on the Services.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-bold text-slate-900">Children's Data</h2>
              <p className="mt-2 text-sm leading-relaxed">
                The Services are not intended to be used by children, and we do not knowingly collect any personal
                information about children under the age of majority in your jurisdiction. If you are the parent
                or guardian of a child who has provided us with their personal information, you may contact us
                using the contact details set out below to request that it be deleted. As of the Effective Date
                of this Privacy Policy, we do not have actual knowledge that we "share" or "sell" (as those terms
                are defined in applicable law) personal information of individuals under 16 years of age.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-bold text-slate-900">Security and Retention of Your Information</h2>
              <p className="mt-2 text-sm leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900">Your Rights and Choices</h2>
              <p className="mt-2 text-sm leading-relaxed">
              ...
              <p className="mt-3 text-sm leading-relaxed">
                ...
                contact details provided below. To learn more about how Shopify uses your personal information and
                any rights you may have, including rights related to data processed by Shopify, you can visit
                <a
                  href="https://privacy.shopify.com/en"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <p className="mt-3 text-sm leading-relaxed">
                ...
                accordance with applicable laws, you may designate an authorized agent to make requests on your
                behalf to exercise your rights. Before accepting such a request from an agent, we will require that
                the agent provide proof you have authorized them to act on your behalf, and we may need you to
            ...
            <section>
              ...
              <p className="mt-2 text-sm leading-relaxed">
                ...
                you live in. If we transfer your personal information out of the European Economic Area or the
                United Kingdom, we will rely on recognized transfer mechanisms like the European Commission's
                Standard Contractual Clauses, or any equivalent contracts issued by the relevant competent
                authority of the UK, as relevant, unless the data transfer is to a country that has been determined
            ...
            <section>
              ...
              <p className="mt-2 text-sm leading-relaxed">
                ...
                this website, update the "Last updated" date and provide notice as required by applicable law.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2 text-sm leading-relaxed">
                ...
                like to exercise any of the rights available to you, please call <strong>+91 90 7405 9164</strong> or
                email us at <strong>clickncartmarketplace@gmail.com</strong> or contact us at:
              </p>
